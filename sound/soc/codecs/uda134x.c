...
SOC_ENUM("Input Mux", uda134x_mixer_enum[2]),                     //   xl  capture chanel 
...
static const struct snd_soc_dai_ops uda134x_dai_ops = {
	...
	.set_sysclk	= uda134x_set_dai_sysclk,         //  xl
	.set_fmt	= uda134x_set_dai_fmt,
};

static struct snd_soc_dai_driver uda134x_dai = {    //  xl snd_soc_card -->> dai link interface   
	.name = "uda134x-hifi",           //  s3c2440  
...
static struct snd_soc_codec_driver soc_codec_dev_uda134x = {           //  xl corresponding  l3  interface 
...
static int __devinit uda134x_codec_probe(struct platform_device *pdev)
{
	return snd_soc_register_codec(&pdev->dev,
			&soc_codec_dev_uda134x, &uda134x_dai, 1);  //   xl  register codec driver  and  dai driver 
}
