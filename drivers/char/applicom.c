...
/* $Id: //CNB/AC8317/MAIN_BR/android/android4.2.2/kernel/drivers/char/applicom.c#1 $			     */
...
static int __init applicom_init(void)
{
	...
	printk(KERN_INFO "Applicom driver: $Id: //CNB/AC8317/MAIN_BR/android/android4.2.2/kernel/drivers/char/applicom.c#1 $\n");
