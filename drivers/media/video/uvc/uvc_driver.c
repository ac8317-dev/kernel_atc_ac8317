...
unsigned int uvc_trace_param = 0x7FF;
unsigned int uvc_timeout_param = UVC_CTRL_STREAMING_TIMEOUT;

// Houston adds 2010/12/02 for Debug print
unsigned int DbgPrint_param = 0x7FF;//0;
		     ...
		     const struct usb_device_id *id)
{
	...
	/*
	 * Bug fix. @Joshua Wang 30/06/2015.
	 * If the status endpoint is enalbe,
	 * The fifo of usb qmu is not enough.
	*/	
#if 0	
	...
	/*Bug fix. By Joshua Wang @ 26/06/2015.     */
	/* If autosuspend is enalbed, uvc_disconnect    */
	/*  will not be called when usb is plug-out.    */
