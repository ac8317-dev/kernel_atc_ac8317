/*
  ...
  $Header: //CNB/AC8317/MAIN_BR/android/android4.2.2/kernel/drivers/scsi/osst.c#1 $
...
static const char * cvsid = "$Id: //CNB/AC8317/MAIN_BR/android/android4.2.2/kernel/drivers/scsi/osst.c#1 $";
