 ...
 *
 * Copyright (C) 2004-2007 Herbert P枚tzl - Arnaud Patard
...
#define DRIVER_AUTHOR	"Herbert P枚tzl <herbert@13thfloor.at>, " \
...
/*---------------------------------------------------------------------------*/
static struct s3c2410_udc memory = {   //   这个  memory 变量代表了S3C2410的USB设备控制器，包括各种信息
	.gadget = {
		.ops		= &s3c2410_ops,
		.ep0		= &memory.ep[0].ep,
		.name		= gadget_name,
